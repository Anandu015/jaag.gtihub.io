  ...
  <main class="hoc container clear"> 
    ...
    <div class="clear">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <input id="Text1" type="text" /><asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                    <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="asssp" />
                    <input id="Button3" type="button" value="htmmm" /></td>
            </tr>
        </table>
&nbsp;<input id="Button2" type="button" value="htm bt" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
  </main>
</div>
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
